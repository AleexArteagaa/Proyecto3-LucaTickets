package com.example.spring.eventos.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI UsuarioOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("LucaTicket API Eventos")
                .description("Documentación de la API de LucaTicket, Microservicio Eventos")
                .version("v1.0")
